package com.example.edugateway_backend.config;
...
import com.example.edugateway_backend.service.JwtService;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        if (userEmail != null && SecurityContextHolder.getContext().getAuthentication() == null) {
            // 6. Check whethcer we have user within the database after the authentication
            // condition
